...
export default function Home() {
  ...
  useEffect(() => {
    if (wrapperRef.current) {
      if (isMobile()) {
        wrapperRef.current.classList.add("is__mobile");
      } else {
        wrapperRef.current.classList.add("is__pc");
      }
    }
    window.scrollTo({
      top: 0,
  ...
  return (
    <div className="home__wrapper" ref={wrapperRef}>
      <video
      ...
      <div className="home__service">
        <Image
          ...
          className="home__service-bg home__video-bg"
          width={1920}
          height={1275}
          src="/first_bg.png"
          alt="bg"
